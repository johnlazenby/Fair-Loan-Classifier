...
#insert path to prep directory
setwd("")

#read in each file and append together
...
#drop fields that do not matter for our analysis
...
#white people that are also other races will not be considered non-hispanic white
df <- df %>% 
...
#create label and filter to only actions 1-3.
df <- df %>% 
